...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/faststream-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/faststream-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install faststream
```
...
It is possible to list all of the versions of `faststream` available on your platform:
...
```
pixi search faststream --channel conda-forge
```
